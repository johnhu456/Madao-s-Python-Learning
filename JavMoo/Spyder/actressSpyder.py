...
from mooAPI.models import Actress
import datetime


def getDetailInfo(uuid):
    anActressDetailUrl = "https://avmo.pw/cn/star/" + uuid
    anActressDetailRequest =urllib2.Request(anActressDetailUrl)
    ...
    avatar = anActressDetailSoup.find(attrs={"class":"photo-frame"}).img['src']
    print avatar
    #获取名字
    name = info.span.text
